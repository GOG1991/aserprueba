...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'servicios.costo_descuento'
        db.add_column('servicios_servicios', 'costo_descuento',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'servicios.costo_descuento'
        db.delete_column('servicios_servicios', 'costo_descuento')
    ...
    models = {
        ...
        'equipos.equipotieneaccesorios': {
            ...
            'accesorio': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'accesorios'", 'to': "orm['equipos.accesorios']", 'default': '1'}),
            'descripcion': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'servicios.detalleservicio': {
            ...
            'respaldo': ('django.db.models.fields.CharField', [], {'null': 'True', 'blank': 'True', 'max_length': '50'}),
            ...
            'solucion': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'soluciones'", 'null': 'True', 'to': "orm['historiales.soluciones']", 'default': '1', 'blank': 'True'})
        },
        'servicios.productos': {
        ...
        'servicios.servicios': {
            ...
            'condicion': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'condiciones'", 'null': 'True', 'to': "orm['servicios.condiciones']", 'default': '1', 'blank': 'True'}),
            'costo': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '6', 'decimal_places': '2', 'blank': 'True'}),
            'costo_descuento': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '6', 'decimal_places': '2', 'blank': 'True'}),
            'costo_respaldo': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '6', 'decimal_places': '2', 'blank': 'True'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'producto': ('django.db.models.fields.related.ManyToManyField', [], {'through': "orm['servicios.servicioTieneProducto']", 'null': 'True', 'to': "orm['servicios.productos']", 'blank': 'True', 'symmetrical': 'False'}),
            'solucion': ('django.db.models.fields.related.ManyToManyField', [], {'through': "orm['servicios.detalleServicio']", 'null': 'True', 'to': "orm['historiales.soluciones']", 'blank': 'True', 'symmetrical': 'False'}),
        ...
        'servicios.serviciotieneproducto': {
            ...
            'subtotal': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'})
        },
