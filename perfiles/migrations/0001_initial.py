...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('perfiles_perfiles', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, related_name='perfil', to=orm['auth.User'])),
            ('direccion', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('ciudad', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clientes.ciudades'])),
            ('telefono', self.gf('django.db.models.fields.CharField')(null=True, max_length=20, blank=True)),
        ))
        db.send_create_signal('perfiles', ['perfiles'])


    def backwards(self, orm):
        # Deleting model 'perfiles'
        db.delete_table('perfiles_perfiles')
